...
function guida(data)
{
    ...
    data['desc'].forEach(function(d){ 
        ...
        r+='<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse1" aria-expanded="true" aria-controls="collapse1">'+d['faq1']+'</a><span class="caret pull-right"></span></h4></div>';
        ...
        r+='<div class="panel panel-default">';
        r+='<div class="panel-heading" role="tab" id="headingOne">';
        r+='<h4 class="panel-title"><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse2" aria-expanded="true" aria-controls="collapseOne">'+d['faq2']+'</a><span class="caret pull-right"></span></h4></div></div>';
        r+='<div class="panel panel-default">';
        r+='<div class="panel-heading" role="tab" id="headingOne">';
        r+='<h4 class="panel-title"><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse3" aria-expanded="true" aria-controls="collapseOne">'+d['faq3']+'</a><span class="caret pull-right"></span></h4></div></div>';
        r+='<div class="panel panel-default">';
        r+='<div class="panel-heading" role="tab" id="headingOne">';
        r+='<h4 class="panel-title"><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse4" aria-expanded="true" aria-controls="collapseOne">'+d['faq4']+'</a><span class="caret pull-right"></span></h4></div></div>';
        r+='</div>';
        r+='</div>';
        r+='</div>';
...
function vprod(data, from, cat, theid,catid)
{
    ...
    data[0].forEach(function(d){
        ...
        r+='<div><h3>'+d['nome']+'</h3>';
        if(d['promozione']!=0){
            r += '<span class="btn-sm btn-success">Promo</span><br><br>';
        }
        if(d['outlet']!=0){
            r += '<span class="btn-sm" style="background-color:#FFFF00">Outlet</span><br><br>';
        }
        r+='</div>';
...
function prodotto(data, from, nomeprodotto, fromid, prodid, midid, midname)
{
    ...
    data.forEach(function(d){
        ...
        if(d['smartlife']!=0){
            ...
            '<div class="col-md-6" style="min-height:50px;"><a href="#" class="btn-lg btn-success cliccabile sl_det"  data-mid-id="'+"983232"+'" data-prod-nome="'+d.smartlife+'" role="button" id="sl_det'+ d['smartlife']+'">Servizio SmartLife</a></div>';
        }
        else{
            r+= '<div class="row">';
            r+= '<div class="col-md-6" style="min-height:50px;"><a href="#" class="btn-lg btn-primary guid cliccabile" role="button">Servizio di Assistenza</a></div>' +
            '<div class="col-md-6" style="min-height:50px;"><a href="#" class="btn-lg btn-success sl_det" data-mid-id="'+"983232"+'" role="button">Servizio SmartLife</a></div>';
        }
        r+= '</div>';
        r+= '</div>';
...
function smartlife(data, from, cat, theid,catid)
{
    ...
    if (cat == "")
        ...
        r += ' id="btnSmartLife" ';
    r += '><a href="#" class="cliccabile">Servizi Smart Life</a></li>\n';
    if (cat != "")
        r += '<li class="active">' + from + '</li>\n';
    r += '</ol>';
    ...
    data['slserv'].forEach(function(d){
        ...
        if(count%2==0){
            ...
            if(d['promozione']!=0){
                r += '<span class="btn-sm btn-success pull-right">Promo</span></h1>';
            }
            else{
                 r+='</h1>';
            }
            ...
            r+='<h1 style="color:red; text-align:center;">'+d['titolo'];
            if(d['promozione']!=0){
                r += '<span class="btn-sm btn-success pull-left">Promo</span></h1>';
            }
            else{
                 r+='</h1>';
            }
